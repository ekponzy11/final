<footer class="page-footer">
		...
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--whybuy">
				...
				<ul class="footer-nav__list">
					...
					<li class="footer-nav__item">
						<a href="#" class="footer-nav__link">promotion</a>
					</li>
					<li class="footer-nav__item">
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				Head Office: Denu-Aflao,.<br>
				Volta region,Ghana.
			</address>
				<div class="phone">
					Telephone:
					<a class="phone__number" href="tel:0548784993">0548-784-993</a>
				</div>
				<div class="email">
					Email:
					<a href="mailto:yourlighvg@gmail.com" class="email__addr">yourlightvg@gmail.com</a>
				</div>
			</div>
	...
	<div class="page-footer__subline">
		<div class="container clearfix">
			...
			<div class="copyright">
				&copy; 2000  your Light;
			</div>

			<div class="developer">
				Dev by Caleb Gbadegbe
			</div>

			<div class="designby">
				Design by Caleb Gbadegbe
			</div>
		</div>
	</div>
</footer>
